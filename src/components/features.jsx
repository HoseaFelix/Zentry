    ...
    return (
        <section className="bg-black pb-52">
            <div className="container mx-auto px-3 md:px-10">
                ...
                <p className="max-w-md font-circular-web txt-lg text-blue-50 opacity-50">
                ...
                <div className="grid h-[135vh]  grid-cols-2 grid-rows-3 gap-7 ">
                    <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2 ">
                        <BentoCard
                            ...
                            title={<>zig<b>m</b>a</>}
                            description="An anime gaming-inspired NFT collection - the IP printed for expansion."
                        />
                    </BentoTilt>
                    ...
                    <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0  ">
                        <BentoCard
                            ...
                            title={<>az<b>u</b>l</>}
                            description="A cross-world AI Agent - elevating your gameplay to be more fun adn productive."
                        />
                    </BentoTilt>
